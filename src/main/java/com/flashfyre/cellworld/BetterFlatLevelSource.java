...
public class BetterFlatLevelSource extends ChunkGenerator {
    public static final MapCodec<BetterFlatLevelSource> CODEC = RecordCodecBuilder.mapCodec(
            p_255577_ -> p_255577_.group(
                    FlatLevelGeneratorSettings.CODEC.fieldOf("settings").forGetter(BetterFlatLevelSource::settings),
                            BiomeSource.CODEC.fieldOf("biome_source").forGetter(BetterFlatLevelSource::getBiomeSource))
                    .apply(p_255577_, p_255577_.stable(BetterFlatLevelSource::new))
    );
    private final FlatLevelGeneratorSettings settings;

    public BetterFlatLevelSource(FlatLevelGeneratorSettings settings, BiomeSource biomeSource) {
